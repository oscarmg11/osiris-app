...
function ChatHelpTodoScreen(){
    ...
    const initializeSocket = () => {
        ...
        newSocket.emit('userConnectedToChat', {userName: context.userName}, (data) => {
            if(data){ dispatchChat({ type: 'SET', value: data.chat }) }
        })
        newSocket.on('newMessage', (newMessage)=> { 
            dispatchChat({ type: 'ADD', value: newMessage })
        })
        setSocket(newSocket)
    }
...
export default ChatHelpTodoScreen;